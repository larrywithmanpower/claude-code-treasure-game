    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-amber-100 flex flex-col items-center justify-center p-8">
      ...
      <div className="mb-8 flex items-center gap-4">
        ...
        {gameEnded && (
          <motion.div
            ...
            className={`relative flex items-center justify-center min-w-[80px] px-6 py-4 rounded-xl shadow-md text-2xl font-bold tracking-wide ${
              score > 0
                ? 'bg-teal-100 text-green-600 border border-teal-200'
                : score === 0
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            {boxes.map((box) => (
              <motion.div
                key={box.id}
                style={!box.isOpen ? { cursor: `url(${keyCursor}) 12 12, pointer` } : undefined}
